...
function postToString( post ) {
	var postToSave = filterPostFor( post, [ 'ID', 'title', 'likes_enabled', 'discussion', 'page_template', 'date', 'status', 'type', 'post_thumbnail', 'sticky', 'slug', 'sharing_enabled', 'featured_image' ] );
